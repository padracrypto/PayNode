...
export default function Navbar() {
  ...
  const handleConnectWallet = async () => {
    if (typeof window.ethereum === 'undefined') {
      alert("Please install MetaMask or a Web3 wallet to use PayNode.");
      return;
    }
  ...
  return (
    <nav className="border-b border-slate-800 bg-slate-900 relative z-50 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
      <div className="max-w-6xl mx-auto px-8 py-4 flex justify-between items-center">
        
        <Link href="/" className="text-2xl font-black text-white hover:text-blue-400 transition-colors">
          PayNode
        </Link>
        ...
        <div>
          {walletAddress ? (
            <div className="flex gap-6 items-center">
              <Link href="/dashboard" className="text-slate-300 hover:text-white font-medium transition-colors text-sm">
                Dashboard
              </Link>
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  ...
                  {unreadCount > 0 && (
                    <span className="absolute top-1.5 right-1.5 w-2.5 h-2.5 bg-blue-500 rounded-full shadow-[0_0_8px_rgba(59,130,246,0.8)] border border-slate-900"></span>
                  )}
                </button>
              ...
              <button className="bg-slate-800/80 border border-slate-700 text-slate-300 px-5 py-2 rounded-xl font-mono text-sm cursor-default hover:border-slate-600 transition-colors">
            ...
            <button 
              ...
              className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-2 rounded-xl font-bold transition-all disabled:bg-slate-600 shadow-[0_0_15px_rgba(37,99,235,0.3)]"
            >
